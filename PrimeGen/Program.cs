...
public static class PrimeGen
{
    ...
    static Boolean IsProbablyPrime(this BigInteger value, int currentCount, int k = 10)
    {
        ...
        Console.WriteLine(currentCount + ": " + value);
        return true;
    }
    ...
    static void GenPrimes(int countToInt, String bit)
    {
        ...
        while (currentCount <= countToInt)
        {
            ...
            else
            {
                ...
                if (randomBitNumber.IsProbablyPrime(currentCount))
                {
                    currentCount++;
                }
